...
int main(int argc, char *argv[])     //argv[1] = number of grid points, argv[i] = numerical and analytical solution printing time step
{
	int grid_points=128; 
	...
	double *error_sum= (double *)malloc((tc+1)*sizeof(double)); 	//for sum of errors of each grid points at various time steps
